...
def delete_join_message(m):
    ...
    try:
        ...
        if m.new_chat_member.id != bot.get_me().id:
            ...
            bot.send_message(m.chat.id,"Привет! Я ваш верный бот GroupSilencer! Спасибо что добавили меня! Чтобы использовать меня, сделайте меня администратором, и я смогу удалить все надоедливые уведомления, когда участник присоединяется к группе или покидает ее!")
